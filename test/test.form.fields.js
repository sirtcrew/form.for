...
import { bootstrap4 as fieldTypes } from "../form.fieldTypes.bootstrap4.js"
...
let form
describe(`Form Field Tests: ${name}`, () => {
    ...
    before(async () => {
        ...
        form = new Llama({
            schema, options, fieldTypes, template, value: {
                Percent_Of_Coolness: 0.9555476, Employee_ID: 12345
            }
    ...
    it('Schema Type: Datetime', async () => {
        ...
        //set through DOM
        field.elementValue = "1982-03-16T10:13"
...
//configureTemplateTest("bootstrap4")
